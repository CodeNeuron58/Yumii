...
description: "A comparison of LLM engines that drive Yumii's intelligence and persona responses."
layout: "cards"
icon: "brain-circuit"
---

<ContentCard>
Yumii is compatible with three major Large Language Model providers. You can choose which model acts as her "Mind" depending on your speed, cost, and intelligence preferences.
...
To optimize system memory and speed, Yumii implements **lazy instantiation** and **caching** of the LLM agents inside `src/yumii/agent/llm.py`:

*   When you switch personalities (e.g. from *Caring* to *Tsundere*), Yumii builds the prompt and compiles the LangChain agent for that personality.
