---
title: "Key Features"
description: "A detailed breakdown of the features that make Yumii a unique companion."
layout: "cards"
icon: "star"
---

<ContentCard>
Yumii is engineered with an emphasis on local performance, visual fluidness, and cryptographic security.
</ContentCard>
...
*   **Tool Integration**: LangChain tools allow Yumii to call local system tools, fetch weather, read dates, and coordinate functions.
*   **Hot-Swappable Persona Matrix**: Instantly change Yumii's behavior mid-sentence. Features six customized personalities.
...
*   **Zero Plaintext Keys on Disk**: Unlike common setups that write API keys to `.env` or configuration JSON files, Yumii leverages the `keyring` package.
