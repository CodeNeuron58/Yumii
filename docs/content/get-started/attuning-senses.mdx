...
description: "Configure Yumii's brain, ears, and voice via the interactive Attunement Wizard."
layout: "cards"
icon: "ear"
---

<ContentCard>
When you launch Yumii for the first time by running `yumii` or `uv run yumii`, she will detect that she doesn't have her keys set up and will guide you through the **Attunement Wizard**. 
...
To let Yumii speak, choose a Text-to-Speech provider:
...
Choose how Yumii listens to your microphone:
