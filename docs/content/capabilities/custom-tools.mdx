...
description: "A step-by-step tutorial on extending Yumi's brain with new Python capabilities."
---
...
1.  Ask: *"Hey Yumi, what is the weather like in Paris?"*
2.  Yumi's LLM will automatically decide to execute the `get_current_weather` tool with `location="Paris"`.
3.  The backend runs your local python request, passes the result back, and she speaks the answer with a matching smile!

Proceed to the [Integration section](/integration/websocket-protocol) to see how to connect other clients to Yumi!
