...
<div style={{ display: 'inline-block', border: '1px solid #22c55e', color: '#22c55e', padding: '2px 10px', borderRadius: '9999px', fontSize: '12px', fontWeight: 'bold', marginBottom: '16px', marginTop: '16px' }}>OVERVIEW</div>

Real-time <span style={{color: '#22c55e'}}>AI companion</span> for terminal-native interaction.
